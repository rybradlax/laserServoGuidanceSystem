        ...
        if len(areaList)>0:
            ...
            if turnList[idx] == 'Right':
                if 1280 - xCoordList[idx] < 300:
                    ...
                    ser.write(s.encode())
                  # print("+10 degrees")
                elif 1280-xCoordList[idx]<450 and 1280-xCoordList[idx]>=300:
                    #transmitData.send2('x') # 5 degrees
                    s = 'x'
                    ser.write(s.encode())
                   # print("+5 degrees")
                elif 1280-xCoordList[idx]<550 and 1280-xCoordList[idx]>=450:
                    #transmitData.send2('z') # 3 degrees
                    s = 'z'
                    ser.write(s.encode())
                   # print("+3 degrees")
                elif 1280-xCoordList[idx]<630 and 1280-xCoordList[idx]>=550:
                    #transmitData.send2('l') # 1 degree
                    s = 'l'
                    ser.write(s.encode())
                  #  print("+1 degree")
            elif turnList[idx] == 'Left':
                if 1280-xCoordList[idx] > 980:
                    #transmitData.send2('m') # 10 degrees
                    s = 'm'
                    ser.write(s.encode())
                   # print("-10 degrees")
                elif 1280-xCoordList[idx]>830 and 1280-xCoordList[idx]<=980:
                    #transmitData.send2('n') # 5 degrees
                    s = 'n'
                    ser.write(s.encode())
                   # print("-5 degrees")
                elif 1280-xCoordList[idx]>730 and 1280-xCoordList[idx]<=830:
                    #transmitData.send2('b') # 3 degrees
                    s = 'b'
                    ser.write(s.encode())
                   # print("-3 degrees")
                elif xCoordList[idx] - 1280>650 and 1280-xCoordList[idx] <=730:
